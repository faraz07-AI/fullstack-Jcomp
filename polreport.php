...
$username=$_POST['place'];
  ...
  if(empty($username)){
   header("Location: ../includes/policereport.php?error=emptyfields");
   exit();
   }
   else{
     ...
     $result=mysqli_query($conn,$sql);
      ...
      if($resultcheck >0){
       ...
       header("Location: ../includes/policereport.php?error=nouser");
       exit();
     ...
     header("Location: ../includes/policereport.php");
     exit();
}
