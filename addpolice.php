...
<body>
<form action="submitpolice.php" method="post">
<body style="background-color:grey;"> 
<table style="width:40%" align="center" border=0 cellspacing=4 >
<tr><td> 
<p><h1><font color="red">POLICE REGISTRATION FORM</font></h1></p></td></tr>
<tr><td>
<p><label><b>name</b></label></td>
<td>
<input type="text" placeholder="enter name" name="username" id="f1" required></p></td></tr>
<tr><td>
<p><label><b>mobile number</b></label></td><td>
<input type="number" placeholder="enter number" name="mobilenumber" id="f2" required></p></td></tr>
<tr><td>
<p><label><b>height</b></label></td><td>
<input type="number" placeholder="enter number" name="heigth" id="f3"  required></p></td></tr>
<tr><td>
<p><label><b>weight</b></label></td><td>
<input type="number" placeholder="enter weight" name="weight" id="f4" required></p></td></tr>
<tr><td>
<p><label><b>email</b></label></td><td>
<input type="email" placeholder="enter email" name="email" id="f5" required></p></td></tr>
<tr><td>
...
<textarea name="address" id="f7" form="usrform">enter the address...........</textarea></p>
</td></tr>
<tr><td>
<p><label><b>country<b></td><td>
<select name="country" id="f8">
